...
async def info_cmd(message: types.Message):
    await message.answer(info_text(), reply_markup=keyboard_return(), parse_mode="HTML")
...
async def cq_info(callback: types.CallbackQuery):
    await callback.message.edit_text(info_text(), reply_markup=keyboard_return(), parse_mode="HTML")
